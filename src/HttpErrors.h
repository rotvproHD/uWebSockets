...
static const std::string_view httpErrorResponses[] = {
    ...
    "HTTP/1.1 505 HTTP Version Not Supported\r\n\r\n<h1>HTTP Version Not Supported</h1><p>This server does not support HTTP/1.0.</p><hr><i>rjweb-server</i>",
    "HTTP/1.1 431 Request Header Fields Too Large\r\n\r\n<h1>Request Header Fields Too Large</h1><hr><i>rjweb-server</i>",
    "HTTP/1.1 400 Bad Request\r\n\r\n<h1>Bad Request</h1><hr><i>rjweb-server</i>"
};
}
